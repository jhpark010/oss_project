 ...
 <%@ include file="../include/header.jsp" %>
    ...
    <section id="speakers-details" class="wow fadeIn">
      <div class="container">
        ...
        <div class="row">
          <div class="col-md-12">
            <iframe width="1120" height="540" src="https://www.youtube.com/embed/g3cNqX5AvxU" frameborder="0" allow="accelerometer; autoplay; encrypted-media; gyroscope; picture-in-picture" allowfullscreen></iframe>
          </div>
          ...
          <div class="col-md-12">
            <div class="details">
              ...
              <hr>
              <p>게임 제목 자체는 '기습공격'이라는 뜻이며 이 게임 때문에 국내에서는 '서든'이라는 단어 자체가 이 게임을 명칭하는 용어나 다름없게 되었다.</p>
              <p>2016년 7월엔 후속작인 서든어택 2가 발표되었지만 게임 내외적으로 논란이 많아서 출시 2개월 만인 2016년 9월 29일에 서비스가 종료되었다.</p>
