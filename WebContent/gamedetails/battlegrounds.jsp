    ...
    <section id="speakers-details" class="wow fadeIn">
      <div class="container">
        <div class="section-header">
          <h2 style="color:white;">배틀 그라운드</h2>
        ...
        <div class="row">
          <div class="col-md-12">
            <iframe width="1120" height="540" src="https://www.youtube.com/embed/hU8oGKzVAmQ" frameborder="0" allow="accelerometer; autoplay; encrypted-media; gyroscope; picture-in-picture" allowfullscreen></iframe>
          </div>
          ...
          <div class="col-md-12">
            <div class="details">
              ...
              <p>이용하여 마지막 1명(1팀)이 살아남는 순간까지 전투를 하게 됩니다</p> 
              <p>플레이어는 점점 좁혀저 오는 경기 구역 내에서 전략적으로 배치된 무기</p>
              <p>차량 및 소모품을 찾아 "최후의 1인(1팀)"이 되기 위해 죽음에 맞선 긴장되고 장엄한 싸움을 하게 될 것입니다.</p>
