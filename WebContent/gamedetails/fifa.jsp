 ...
 <%@ include file="../include/header.jsp" %>
    ...
    <section id="games-details" class="wow fadeIn">
      <div class="container">
        ...
        <div class="row">
          <div class="col-md-12">
            <iframe width="1120" height="540" src="https://www.youtube.com/embed/aVoZLC8aGyc" frameborder="0" allow="accelerometer; autoplay; encrypted-media; gyroscope; picture-in-picture" allowfullscreen></iframe>
          </div>
          ...
          <div class="col-md-12">
            <div class="details">
              ...
              <p>전 세계 축구 리그의 선수들로 플레이 할 수 있는 최고의 온라인 축구 게임 입니다.</p> 
              <p>2017년 11월 2일에 열린 EA x 넥슨 뉴 프로젝트 미디어 쇼케이스 에서 처음으로 공개되었다.</p>
              <p>2018년 5월 17일에 서비스를 시작했다.</p>
