    ...
    <section id="games-details" class="wow fadeIn">
      <div class="container">
        <div class="section-header">
          <h2 style="color:white;">던전 앤 파이터</h2>
          <p>Dungeon and Fighter</p>
        </div>
        ...
        <div class="row">
          <div class="col-md-12">
            <iframe width="1120" height="540" src="https://www.youtube.com/embed/Vu6j4DpfDj4" frameborder="0" allow="accelerometer; autoplay; encrypted-media; gyroscope; picture-in-picture" allowfullscreen></iframe>
          </div>
          ...
          <div class="col-md-12">
            <div class="details">
              ...
              <hr>
              <p>'빠른 플레이'라는 문구에 딱 들어맞는 게임으로, 별다른 생각없이 가볍게 한판 놀 수 있는 오락실 아케이드 게임의 온라인 버전이다.</p> 
              <p> 복잡하게 생각할 것 없이 무작정 던전으로 쳐들어가서 몬스터를 차고, 쏘고, 잡고, 꺾는다는 벨트스크롤 액션 게임 기반 특유의 플레이 방식 덕분에</p>
              <p>간단하게 시간 죽일 수 있는 물건이 그다지 많지 않은 한국 온라인 게임 풍토 속에서 저연령층에서 청장년층까지 폭넓은 유저층을 끌어모으는 인기 게임으로 등극할 수 있었다.</p>
              <p>특히 한국과 중국은 안 해본 게이머가 없을 정도이다.</p>
