 ...
 <%@ include file="../include/header.jsp" %>
    ...
    <section id="games-details" class="wow fadeIn">
      <div class="container">
        ...
        <div class="row">
          <div class="col-md-12">
            <iframe width="1120" height="540" src="https://www.youtube.com/embed/bSflZBmCbTM" frameborder="0" allow="accelerometer; autoplay; encrypted-media; gyroscope; picture-in-picture" allowfullscreen></iframe>
          </div>
          ...
          <div class="col-md-12">
            <div class="details">
              ...
              <p>'체이싱 라이트'는 그 질문의 과정이자 게임의 물성을 탐구하는, 그리고 인간과 사회의 내면을 파헤치는 7일간의 여로에 관한 이야기입니다.</p> 
              <p>여러분은 게임 제작진이 되어 ‘체이싱 라이트’라는 게임을 만들게 됩니다.</p>
              <p>감독과 프로듀서를 조종하며 게임 제작 과정에서 내려야 할 여러 가지 결정들, 음악의 선택과 효과음의 선택, 적들의 수와 투입 속도, 공격 속도 등을 결정하게 되고</p>
              <p>정체를 알 수 없는 손들의 도움을 받으며 게임을 성공시키기 위해 고군분투하게 될 것입니다. </p>
            </div>
          </div>
